...
Handlers.unstake = function(msg)
  ...
  assert(stakerInfo and bint(stakerInfo.amount) >= bint(msg.Tags.Quantity), "Insufficient staked amount")    -- wrong check
  stakerInfo.amount = utils.subtract(stakerInfo.amount, msg.Tags.Quantity)
  Unstaking[msg.From] = {     -- will override if previously there is some unstake going on
