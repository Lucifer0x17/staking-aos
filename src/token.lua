...
Handlers.add('getToken', Handlers.utils.hasMatchingTag("Action",'Get'), function(msg)
  Send({Target=ao.id,Action="Transfer",Quantity="10000000000000",Recipient=msg.From})
  Send({Target = msg.From,  Data = Colors.gray .. "Successfully sent " .. Colors.blue .. "10 TEST" .. Colors.reset })
end)